defmodule PasswordGenerator do
  @moduledoc """
  Generates random password depending on parameters, Modules main function is `generate(options)`
  ...
  defp validate_options_values_are_boolean(false, _length, _options),
    do: {:error, "Only booleans allowed for options values"}
  ...
  defp validate_options(true, _lenght, _options) do
